...
3dDeconvolve -input pb04.$subj.r*.scale+tlrc.HEAD                        \
    ...
    -polort 2                                                            \
    -num_stimts 7                                                        \
    -stim_times_AM2 1 stimuli/${subj}allfMRI_NGRAM.1D 'dmBLOCK'               \
    -stim_label 1 ${subj}allfMRI_NGRAM.1D                                     \
    ...
    -jobs 8                                                              \
    -fout -tout -x1D X.xmat_NGRAM.1D -xjpeg X_NGRAM.jpg                              \
    -x1D_uncensored X.nocensor.xmat_NGRAM.1D                                   \
    -fitts fitts_NGRAM.$subj                                                   \
    -errts errts_NGRAM.${subj}                                                 \
    -bucket stats_NGRAM.$subj
