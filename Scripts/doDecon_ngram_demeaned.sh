...
3dDeconvolve -input pb04.$subj.r*.scale+tlrc.HEAD                        \
    ...
    -polort 2                                                            \
    -num_stimts 7                                                        \
    -stim_times_AM2 1 stimuli/${subj}allfMRI_demeaned_NGRAM.1D 'dmBLOCK'               \
    -stim_label 1 ${subj}allfMRI_demeaned_NGRAM.1D                                     \
    ...
    -jobs 8                                                              \
    -fout -tout -x1D X.xmat_ngram_demeaned.1D -xjpeg X_ngram_demeaned.jpg                              \
    -x1D_uncensored X.nocensor.xmat_ngram_demeaned.1D                                   \
    -fitts fitts_ngram_demeaned.$subj                                                   \
    -errts errts_ngram_demeaned.${subj}                                                 \
    -bucket stats_ngram_demeaned.$subj
